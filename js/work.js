...
function executeCommand(base, end, req){
    let url = base+end;
    let responseData;
...
function setFirst(){
    ...
    let response = executeCommand(baseURL, irl, req);
...
function saveData(){
    ...
    jQuery.ajaxSetup({async: false});
    let response = executeCommand(baseURL, iml, req);
    jQuery.ajaxSetup({async: true});
...
function changeData(){
    ...
    jQuery.ajaxSetup({async: false});
    executeCommand(baseURL, iml, req);
    jQuery.ajaxSetup({async: true});
